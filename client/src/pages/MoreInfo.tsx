...
const MoreInfo = () => {
  ...
  const getDirectors = () => {
    ...
    if (content.originalData?.movie?.director) {
  ...
  const getWriters = () => {
    ...
    if (content.originalData?.movie?.writer) {
  ...
  const getCastMembers = () => {
    ...
    if (content.originalData?.movie?.cast_members) {
                ...
                <div className="lg:col-span-2 space-y-6 min-w-0">
                  ...
                  <div className="space-y-4 border-t border-border/30 pt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      {getContentType() === 'Movie' && content.originalData?.movie?.duration && (
                        <div>
                          ...
                          <span className="bg-indigo-800/20 text-indigo-300 px-2 py-1 rounded border border-indigo-700/30 text-xs">
                            {content.originalData.movie.duration} minutes
                          </span>
                        </div>
                      )}

                      {getContentType() !== 'Movie' && episodeCount && (
                        <div>
